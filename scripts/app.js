...
for(let history of limitedFound){
  historyContent +=
  `
  <p><span class="time-span">${history.date} :</span> <a href="${history.charLink target="_blank"}">${history.nick}</a> found <span class="boss-name">Drakon The Devourer</span> on ${history.server}.</p>
  `
}
